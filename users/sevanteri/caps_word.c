...
// This particular was first implementation is by @dnaq at splitkb.com discord.
// Idea originally from @iaap, also at splitkb.com discord.
// Other masterminds part of the process: @precondition, @TheoL, @johnm

// Modified by @sevanteri (added underscores on spaces)
// Modified by @metheon (added ability to toggle between states)
// Modified by @baffalop (added snake_case escape with double space)
